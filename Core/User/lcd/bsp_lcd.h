...
#define DMA2D_SWITCH 1   //DMA2D图形加速开关 0：关 1：开
#define BGLIGHT_SWITCH 1 //背光亮度调节模式 0：开关 1：PWM
/* LCD 物理像素大小 (宽度和高度) */
...
#define L8 LTDC_PIXEL_FORMAT_L8             /*!< L8 LTDC pixel format       */
#define AL44 LTDC_PIXEL_FORMAT_AL44         /*!< AL44 LTDC pixel format     */
#define AL88 LTDC_PIXEL_FORMAT_AL88         /*!< AL88 LTDC pixel format     */
...
typedef enum
{
  PRELOAD_DFT = 0x00U,  //默认
  PRELOAD_RDY = 0x01U,  //预加载准备
  PRELOAD_OK = 0x02U,   //预加载完成
  PRELOAD_OVER = 0x04U, //超范围
  PRELOAD_ERR = 0x08U,  //错误：设置了对某层的预加载，但未使用，有去冲设置其他预加载层
  PRELOAD_RST = 0x10U   //需要重置
} LCD_PreloadStateTypeDef;

typedef struct
{
  uint32_t SelLayer;             //选中层(0:BG 1:FG)
  uint32_t OriSence;             //选中层原缓存区
  uint32_t AimSence;             //选中层目标缓存区
  LCD_PreloadStateTypeDef State; //状态
} LCD_PreloadTypeDef;
...
#define LCD_FB_FIFO_SIZE ((uint32_t)0x800000)
/** 
  * @brief  LCD color  
  */
...
#define LTDC_G3_GPIO_CLK_ENABLE() __HAL_RCC_GPIOH_CLK_ENABLE()
...
#define LTDC_G6_GPIO_CLK_ENABLE() __HAL_RCC_GPIOI_CLK_ENABLE()
#define LTDC_G6_GPIO_PIN GPIO_PIN_1
#define LTDC_G6_AF GPIO_AF14_LTDC

#define LTDC_G7_GPIO_PORT GPIOD
#define LTDC_G7_GPIO_CLK_ENABLE() __HAL_RCC_GPIOD_CLK_ENABLE()
...
#define LTDC_B2_GPIO_CLK_ENABLE() __HAL_RCC_GPIOG_CLK_ENABLE()
...
#define LTDC_DISP_GPIO_CLK_ENABLE() __HAL_RCC_GPIOI_CLK_ENABLE()
#define LTDC_DISP_GPIO_PIN GPIO_PIN_11
/*液晶屏背光亮度，低电平使能*/
extern TIM_HandleTypeDef htim14;
#define BL_PWM_Handler htim14
#define LTDC_BL_GPIO_PORT GPIOF
#define LTDC_BL_GPIO_CLK_ENABLE() __HAL_RCC_GPIOF_CLK_ENABLE()
#define LTDC_BL_TIM_CLK_ENABLE() __HAL_RCC_TIM14_CLK_ENABLE()
#define LTDC_BL_GPIO_PIN GPIO_PIN_9
#define LTDC_BL_AF GPIO_AF9_TIM14
#define LTDC_BL_PWM_CHANNEL TIM_CHANNEL_1
#define LTDC_BL_PWM_MAX 100
#define LTDC_BL_PWM_MIN 25
